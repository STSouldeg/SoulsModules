...
# Author: iamnalinor
# Commands:
# .mute | .unmute | .mutelist | .muteclear
# ---------------------------------------------------------------------------------
...
class muteMod(loader.Module):
    ...
    strings = {
        "name": "mute",
        "author": "@userbothikka3",
        "not_group": "🚫 <b>This command is for groups only</b>",
        "muted": "🔇 <b>muted {user} for {time}</b>",
        "muted_forever": "🔇 <b>muted {user} indefinitely</b>",
        "unmuted": "🔉 <b>Removed mute from {user}</b>",
    ...
    strings_ru = {
        ...
        "_cmd_doc_mute": (
            "<reply/username/id> <время> — Добавить пользователя в список mute"
        ),
        "_cmd_doc_unmute": (
            "<reply/username/id> — Удалить пользователя из списка mute"
        ),
        "_cmd_doc_mutelist": "Получить пользователей в списке mute",
        "_cmd_doc_muteclear": (
            "<all> — Удалить всех пользователей из списка mute в этом/всех чатах"
        ),
        "not_group": "🚫 <b>Эта команда предназначена только для групп</b>",
        "muted": "🔇 <b>{user} добавлен в список mute на {time}</b>",
        "muted_forever": "🔇 <b>{user} добавлен в список mute навсегда</b>",
        "unmuted": "🔉 <b>{user} удалён из списка mute</b>",
        ...
        "muted_users": "📃 <b>Пользователи в списке mute:</b>\n{names}",
    ...
    async def muteclearcmd(self, message: Message):
